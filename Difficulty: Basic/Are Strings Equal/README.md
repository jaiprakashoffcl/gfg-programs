<h2><a href="https://www.geeksforgeeks.org/problems/are-strings-equal/1?page=1&category=Java&sortBy=accuracy">Are Strings Equal</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two strings s1 and s2, find if they contain the same data or not.</span></p>
